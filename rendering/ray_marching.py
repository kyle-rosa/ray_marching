...
def make_ndc_coordinates(pixels_resolution, dtype=torch.float32):
...
class PinholeCamera(nn.Module):
    def __init__(
        ...
        self.register_buffer('focus', torch.tensor([[0., 0., focal_length]])[:, None, None, :].expand(num_cameras, 1, 1, 3))
